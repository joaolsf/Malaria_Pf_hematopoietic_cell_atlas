...
def nhood_enrichment_hyperion(adata, cluster_identifier, ROI_column_name, ROIs_to_exclude=[],radius=20,run_initial=True,average_over_rois=True):
    ...
    for i in ROI_list:
        ...
        sq.gr.spatial_neighbors(working_adata, radius=radius, coord_type="generic")
